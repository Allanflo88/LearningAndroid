package com.visualizador.visualizadordeimagens;
...
public class VisualizadorImagensActivity extends AppCompatActivity {
    ...
    private Button btFoto1, btFoto2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btFoto1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                imgFoto.setImageResource(R.drawable.allan);

                txInfo.setText(R.string.foto1);
        ...
        btFoto2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                imgFoto.setImageResource(R.drawable.captura);

                txInfo.setText(R.string.foto2);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_visualizador_imagens, menu);
        return true;
    }
